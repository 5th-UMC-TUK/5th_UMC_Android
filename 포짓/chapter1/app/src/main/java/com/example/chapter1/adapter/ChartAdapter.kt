...
import com.example.chapter1.databinding.ChartListBinding
import com.example.chapter1.model.Song

class ChartAdapter : ListAdapter<Song, RecyclerView.ViewHolder>(DiffCallBack) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val binding = ChartListBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ViewHolderShared(binding)
    }

    inner class ViewHolderShared(private val binding: ChartListBinding) :
